                ...
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            주간 게시글수
                            <c:forEach items="${postsPS}" var="postsPS">
                                <input type="hidden" class="numOfPosts" value="${postsPS.numOfPosts}">
                            </c:forEach>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            월별 가입자 수
                            <c:forEach items="${signupPS}" var="signupPS">
                                <input type="hidden" class="monthSignupCount" value="${signupPS.monthSignupCount}">
                            </c:forEach>
                        </div>
                        <div class="card-body">
