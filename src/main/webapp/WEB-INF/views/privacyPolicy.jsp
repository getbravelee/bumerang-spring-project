...
<p>
  <부메랑>(‘www.bumerang.com’이하 '부메랑') 은 다음의 목적을 위하여
...
<p>
  ① ‘부메랑’은 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보
...
<p>
  ① 정보주체는 ‘부메랑’ 에 대해 언제든지 다음 각 호의 개인정보 보호 관련
  권리를 행사할 수 있습니다.
</p>
<p>1. 개인정보 열람요구</p>
...
<p>① ‘부메랑’은 다음의 개인정보 항목을 처리하고 있습니다.</p>
<p>
  <‘부메랑’에서 수집하는 개인정보 항목> ‘부메랑’ 회원 가입 및 고객 문의 시,
  제공 동의를 해주시는 개인정보 수집 항목입니다.
</p>
<p>■ 회원 가입 시(회원)</p>
<p>– 필수항목 : 이름, 이메일, 전화번호, 성별, 연령대</p>
<p>– 선택항목 : 생년월일</p>
<p>– 수집목적 : 부메랑 회원관리 및 마케팅 이용</p>
<p>– 보유기간 : 회원 탈퇴 또는 동의철회 시 지체없이 파기</p>
<p>■ 고객 문의 시(비회원)</p>
<p>– 필수항목 : 문의종류, 이름, 휴대폰번호, 이메일, 문의사항</p>
<p>
  – 수집목적 : 고객문의 및 상담요청에 대한 회신, 상담을 위한 서비스 이용기록
  조회
</p>
<p>
...
<p>
  아래는 ‘어반러드렛’ 회원 가입 시(카카오 계정을 통한 간편 가입시) 제공
  동의를 해주시는 자동 수집 항목입니다.
</p>
<p>
...
<p>– 선택항목 : 생일, 출생연도</p>
<p>– 수집목적 : 부메랑 카카오채널을 통한 회원관리 및 마케팅 이용</p>
<p>– 보유기간 : 카카오채널 탈퇴 또는 동의철회 시 지체없이 파기</p>
<p>
  ② ‘부메랑’은 만 14세 미만 아동의 개인정보를 보호하기 위하여 회원가입은
...
<p>
  ‘부메랑’은 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당
...
<p>
  ① ‘부메랑’은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
...
<p>
  ① ‘부메랑’은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
...
<p>직책 : 대표</p>
<p>직급 : CEO</p>
<p>연락처 : 1577-8725, contact@jpinnovation.kr</p>
<p>※ 개인정보 보호 담당부서로 연결됩니다.</p>
<p>▶ 개인정보 보호 담당부서</p>
<p>부서명 : 마케팅팀</p>
<p>담당자 : 곽은미</p>
<p>연락처 : 1577-8725, amykwak@jpinnovation.kr</p>
<p>
  ② ‘부메랑’의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호
  관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
  담당부서로 문의하실 수 있습니다.
</p>
<p>
  ‘부메랑’은 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
</p>
<p>
...
<p>
  ...
  <strong
  >‘부메랑’은 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에
...
<p>
  ‘부메랑’은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기
  위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이
...
<p>
  ...
  알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금
...
<p>
  아래의 기관은 (주)제이피 이노베이션 과는 별개의 기관으로서, ‘부메랑’의
