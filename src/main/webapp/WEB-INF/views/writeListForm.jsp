                                                ...
                                                <a href="/s/api/user/detailForm/${job.userId}" style="display: flex;">
                                                    <div>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise><img class="icon"
                                                                    src="/img/${job.userProfileImg}">
                                                            </c:otherwise>
                                                        </c:choose>
                                    ...
                                    <div class="info">
                                        <div class="badge">
                                            <c:if test="${pf.pfGenre == '단편영화' || pf.pfGenre == '장편영화'}">
                                                <div class="category forMovie"><i class="fa-solid fa-clapperboard"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '연극'}">
                                                <div class="category forTheater"><i
                                                        class="fa-solid fa-masks-theater"></i> ${pf.pfGenre}
                                                </div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '드라마'}">
                                                <div class="category forDrama"><i class="fa-solid fa-panorama"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '웹 컨텐츠'}">
                                                <div class="category forWebContent"><i class="fa-solid fa-icons"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '광고'}">
                                                <div class="category forAdvertising"><i class="fa-solid fa-video"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '전시'}">
                                                <div class="category forExhibition"><i class="fa-solid fa-palette"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
                                            <c:if test="${pf.pfGenre == '기타'}">
                                                <div class="category forEtc"><i class="fa-solid fa-paperclip"></i>
                                                    ${pf.pfGenre}</div>
                                            </c:if>
